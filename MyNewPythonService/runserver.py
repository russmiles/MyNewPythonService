...
from MyNewPythonService import create_app
...
def run_dev():
    ...
    """
    app.config.from_object("MyNewPythonService.settings_dev")
    app.run()
...
def run_prod():
    ...
    """
    app.config.from_object("MyNewPythonService.settings_prod")
